...
from c_svmlight_loader import _load_svmlight_string
from c_svmlight_loader import _dump_svmlight_file


def load_svmlight_string(rawdata, n_features=None, dtype=None, zero_based="auto"):
    ...
    """
    data, indices, indptr, labels = _load_svmlight_string(rawdata)
